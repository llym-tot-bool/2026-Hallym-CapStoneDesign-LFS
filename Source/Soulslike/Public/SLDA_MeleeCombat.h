...
DECLARE_MULTICAST_DELEGATE(FSLDLG_AN_Translation)
DECLARE_MULTICAST_DELEGATE(FSLDLG_AN_Recovery)
DECLARE_MULTICAST_DELEGATE(FSLDLG_AN_CutMontage)


DECLARE_MULTICAST_DELEGATE(FSLDLG_CharacterMove)
